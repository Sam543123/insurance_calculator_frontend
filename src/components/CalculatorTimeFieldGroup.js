            ...
            {props.insuranceType !== "cumulative insurance" && (
                <React.Fragment>
                    <CalculatorField labelText="Enter birth date of the insured:">
                        ...
                        {props.birthDateErrors && <div className="error">{props.birthDateErrors.messages.map((m)=><p>{m}</p>)}</div>}
                    </CalculatorField>
                    <CalculatorField labelText="Enter start date of insurance:">
                        ...
                        {props.insuranceStartDateErrors && <div className="error">{props.insuranceStartDateErrors.messages.map((m)=><p>{m}</p>)}</div>}
                    </CalculatorField>
                </React.Fragment>
            )}
